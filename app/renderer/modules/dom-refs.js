...
export const perchanceCliPathInput = document.getElementById('perchanceCliPath');
export const perchanceServerDetails = document.getElementById('perchanceServerDetails');
export const perchanceServerActions = document.querySelector('.perchance-server-actions');
export const perchanceServerBtns = Array.from(document.querySelectorAll('.perchance-server-btn'));
...
export const veniceVideoAspectRatioSelect = document.getElementById('veniceVideoAspectRatio');
export const veniceTtsModelSelect = document.getElementById('veniceTtsModel');
export const veniceTtsModelGroup = document.getElementById('veniceTtsModelGroup');
...
export const loreNovelaiModelSettings = document.getElementById('loreNovelaiModelSettings');
...
export const rpgCastView = document.getElementById('rpgCastView');
export const rpgPartySection = document.getElementById('rpgPartySection');
export const rpgQuestSection = document.getElementById('rpgQuestSection');
export const rpgNpcSection = document.getElementById('rpgNpcSection');
export const rpgInventorySection = document.getElementById('rpgInventorySection');
export const rpgCurrencySection = document.getElementById('rpgCurrencySection');
export const rpgStatusSection = document.getElementById('rpgStatusSection');
export const rpgFactionsSection = document.getElementById('rpgFactionsSection');
export const rpgClassesSection = document.getElementById('rpgClassesSection');
export const rpgRacesSection = document.getElementById('rpgRacesSection');
